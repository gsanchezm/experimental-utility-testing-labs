...
| protocol/mobile-runner-policy-v1.md | Mobile runner candidates, fallback, qualification gate (MQ1, MQ2, MQ3; qualification SUT; pass criteria), per-SUT compatibility smoke | v1 | AMENDED (2026-09-26; superseded by protocol/mobile-runner-policy-v2.md; the Mobilewright qualification executed under it remains valid under v1) |
| protocol/mobile-runner-policy-v2.md | Same scope as v1; section 9 amended (PROTO-U17): compatibility-smoke attribution (FAIL_RUNNER, NOT_EXECUTED with a demonstrated SUT_BUILD / INFRASTRUCTURE / HARNESS_ORCHESTRATION cause, conservative tie-break), effects of each result, exhausted-fallback rule and study-level status UNRESOLVED_AFTER_FALLBACK_FAILURE; sections 1-8 and 10 verbatim from v1 | v2 | FROZEN-PRE-DATA (2026-09-26; human approval 2026-09-25; record manifests/mobile-runner-policy-v2-amendment-v1.yaml) |
