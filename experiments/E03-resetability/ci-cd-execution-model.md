...
7. For an ANDROID or IOS condition: `manifests/toolchain-manifest.yaml` records `qualification_status: PASSED` and `compatibility_smoke_status: PASSED`, a selected runner version, and Appium 3 (never Appium 2) as the fallback.
