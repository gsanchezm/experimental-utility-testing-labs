...
| Compatibility smoke | NOT AUTHORIZED / NOT STARTED — applies to the selected runner, Appium 3 (for E03-resetability: SUT-02 Android and SUT-02 iOS); prepared and re-locked under protocol/mobile-runner-policy-v2.md (2026-09-26; qualification/compatibility-smoke/README.md); requires a further explicit human instruction |
