...
Cells disputed by ADJUDICATOR-EU-01 are cross-referenced here by AUDITOR-SUT03-BROWSERSTACK as rows of the table above (raised_by = ADJUDICATOR-EU-01), each pointing to the adjudicator's record outside audits/ (protocol/agent-governance-v1.md). The adjudicator does not write in this file.
